...
namespace Infra.DatabaseConfiguration_EF_AvansSurplusMealService.Migrations
{
    ...
    [Migration("20221005172048_changed names")]
            ...
            modelBuilder.Entity("Core.Domain.Domain.MealPacket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CantineId = 1,
                            DeadlineDate = new DateTime(2022, 10, 6, 19, 20, 48, 361, DateTimeKind.Local).AddTicks(1761),
                        ...
                        new
                        {
                            Id = 2,
                            CantineId = 2,
                            DeadlineDate = new DateTime(2022, 10, 7, 19, 20, 48, 361, DateTimeKind.Local).AddTicks(1767),
                            Name = "Vleespakket",
                            Opgehaald = false,
                            Price = 25.0,
                            ReservationDate = new DateTime(2022, 10, 6, 19, 20, 48, 361, DateTimeKind.Local).AddTicks(1769),
                            StudentClaimId = 1,
                            TypeMeal = "Vless"
                        },
                        new
                        {
                            Id = 3,
                            CantineId = 1,
                            DeadlineDate = new DateTime(2022, 10, 7, 19, 20, 48, 361, DateTimeKind.Local).AddTicks(1776),
                            Name = "Vegapakket",
                            Opgehaald = false,
                            Price = 12.99,
                            TypeMeal = "Gezond"
                        ...
                        new
                        {
                            Id = 4,
                            CantineId = 2,
                            DeadlineDate = new DateTime(2022, 10, 8, 19, 20, 48, 361, DateTimeKind.Local).AddTicks(1780),
                        ...
                        new
                        {
                            Id = 5,
                            CantineId = 1,
                            DeadlineDate = new DateTime(2022, 10, 9, 19, 20, 48, 361, DateTimeKind.Local).AddTicks(1783),
                            Name = "Snackpakket",
                            Opgehaald = false,
                            Price = 12.5,
                            TypeMeal = "Snack"
                        ...
                        new
                        {
                            Id = 6,
                            CantineId = 2,
                            DeadlineDate = new DateTime(2022, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Hartige pakket",
                            Opgehaald = false,
