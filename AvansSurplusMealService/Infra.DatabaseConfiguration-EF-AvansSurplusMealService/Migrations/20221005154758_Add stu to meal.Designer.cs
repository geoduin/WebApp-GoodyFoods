...
namespace Infra.DatabaseConfiguration_EF_AvansSurplusMealService.Migrations
{
    ...
    [Migration("20221005154758_Add stu to meal")]
    partial class Addstutomeal
    {
            ...
            modelBuilder.Entity("Core.Domain.Domain.MealPacket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CantineId = 1,
                            DateToReceive = new DateTime(2022, 10, 6, 17, 47, 57, 938, DateTimeKind.Local).AddTicks(3059),
                        ...
                        new
                        {
                            Id = 2,
                            CantineId = 2,
                            DateToReceive = new DateTime(2022, 10, 7, 17, 47, 57, 938, DateTimeKind.Local).AddTicks(3066),
                            Name = "Vleespakket",
                            Opgehaald = false,
                            Price = 25.0,
                            StudentClaimId = 1,
                        ...
                        new
                        {
                            Id = 3,
                            CantineId = 1,
                            DateToReceive = new DateTime(2022, 10, 7, 17, 47, 57, 938, DateTimeKind.Local).AddTicks(3069),
                            Name = "Vegapakket",
                            Opgehaald = false,
                            Price = 12.99,
                            TypeMeal = "Gezond"
                        ...
                        new
                        {
                            Id = 4,
                            CantineId = 2,
                            DateToReceive = new DateTime(2022, 10, 8, 17, 47, 57, 938, DateTimeKind.Local).AddTicks(3072),
                        ...
                        new
                        {
                            Id = 5,
                            CantineId = 1,
                            DateToReceive = new DateTime(2022, 10, 9, 17, 47, 57, 938, DateTimeKind.Local).AddTicks(3075),
                            Name = "Snackpakket",
                            Opgehaald = false,
                            Price = 12.5,
                            TypeMeal = "Snack"
