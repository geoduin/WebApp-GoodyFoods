...
namespace Infra.DatabaseConfiguration_EF_AvansSurplusMealService.Migrations
{
    ...
    [Migration("20221005163654_Changed value")]
            ...
            modelBuilder.Entity("Core.Domain.Domain.MealPacket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CantineId = 1,
                            DateToReceive = new DateTime(2022, 10, 6, 18, 36, 54, 310, DateTimeKind.Local).AddTicks(7210),
                            Name = "Zomerse Special",
                            Opgehaald = false,
                            Price = 21.879999999999999,
                            TypeMeal = "Gezond"
                        },
                        new
                        {
                            Id = 2,
                            CantineId = 2,
                            DateToReceive = new DateTime(2022, 10, 7, 18, 36, 54, 310, DateTimeKind.Local).AddTicks(7217),
                            Name = "Vleespakket",
                            Opgehaald = false,
                            Price = 25.0,
                            ReserveDate = new DateTime(2022, 10, 6, 18, 36, 54, 310, DateTimeKind.Local).AddTicks(7219),
                            StudentClaimId = 1,
                            TypeMeal = "Vless"
                        },
                        new
                        {
                            Id = 3,
                            CantineId = 1,
                            DateToReceive = new DateTime(2022, 10, 7, 18, 36, 54, 310, DateTimeKind.Local).AddTicks(7225),
                            Name = "Vegapakket",
                            Opgehaald = false,
                            Price = 12.99,
                            TypeMeal = "Gezond"
                        ...
                        new
                        {
                            Id = 4,
                            CantineId = 2,
                            DateToReceive = new DateTime(2022, 10, 8, 18, 36, 54, 310, DateTimeKind.Local).AddTicks(7228),
                            Name = "Sandwich pakket",
                            Opgehaald = false,
                            Price = 10.0,
                            TypeMeal = "Sandwiches"
                        },
                        new
                        {
                            Id = 5,
                            CantineId = 1,
                            DateToReceive = new DateTime(2022, 10, 9, 18, 36, 54, 310, DateTimeKind.Local).AddTicks(7231),
                            Name = "Snackpakket",
                            Opgehaald = false,
                            Price = 12.5,
                            TypeMeal = "Snack"
                        ...
                        new
                        {
                            Id = 6,
                            CantineId = 2,
                            DateToReceive = new DateTime(2022, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Hartige pakket",
                            Opgehaald = false,
