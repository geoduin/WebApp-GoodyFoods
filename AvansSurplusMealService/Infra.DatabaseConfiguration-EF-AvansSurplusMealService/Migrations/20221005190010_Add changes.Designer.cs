...
namespace Infra.DatabaseConfiguration_EF_AvansSurplusMealService.Migrations
{
    ...
    [Migration("20221005190010_Add changes")]
            ...
            modelBuilder.Entity("Core.Domain.Domain.MealPacket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CantineId = 1,
                            DeadlineDate = new DateTime(2022, 10, 6, 21, 0, 10, 64, DateTimeKind.Local).AddTicks(6157),
                        ...
                        new
                        {
                            Id = 2,
                            CantineId = 2,
                            DeadlineDate = new DateTime(2022, 10, 7, 21, 0, 10, 64, DateTimeKind.Local).AddTicks(6164),
                            Name = "Vleespakket",
                            Opgehaald = false,
                            Price = 25.0,
                            ReservationDate = new DateTime(2022, 10, 6, 21, 0, 10, 64, DateTimeKind.Local).AddTicks(6166),
                            StudentClaimId = 1,
                            TypeMeal = "Vless"
                        },
                        new
                        {
                            Id = 3,
                            CantineId = 1,
                            DeadlineDate = new DateTime(2022, 10, 7, 21, 0, 10, 64, DateTimeKind.Local).AddTicks(6172),
                            Name = "Vegapakket",
                            Opgehaald = false,
                            Price = 12.99,
                            TypeMeal = "Gezond"
                        ...
                        new
                        {
                            Id = 4,
                            CantineId = 2,
                            DeadlineDate = new DateTime(2022, 10, 8, 21, 0, 10, 64, DateTimeKind.Local).AddTicks(6175),
                        ...
                        new
                        {
                            Id = 5,
                            CantineId = 1,
                            DeadlineDate = new DateTime(2022, 10, 9, 21, 0, 10, 64, DateTimeKind.Local).AddTicks(6178),
                            Name = "Snackpakket",
                            Opgehaald = false,
                            Price = 12.5,
                            TypeMeal = "Snack"
