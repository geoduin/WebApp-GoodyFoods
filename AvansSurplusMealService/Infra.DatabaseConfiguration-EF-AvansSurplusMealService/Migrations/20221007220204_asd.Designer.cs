            ...
            modelBuilder.Entity("Core.Domain.Domain.MealPacket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CantineId = 1,
                            DeadlineDate = new DateTime(2022, 10, 9, 0, 2, 4, 398, DateTimeKind.Local).AddTicks(4928),
                        ...
                        new
                        {
                            Id = 2,
                            CantineId = 2,
                            DeadlineDate = new DateTime(2022, 10, 10, 0, 2, 4, 398, DateTimeKind.Local).AddTicks(4933),
                            Name = "Vleespakket",
                            Opgehaald = false,
                            Price = 25.0,
                            StudentClaimId = 1,
                        ...
                        new
                        {
                            Id = 3,
                            CantineId = 1,
                            DeadlineDate = new DateTime(2022, 10, 10, 0, 2, 4, 398, DateTimeKind.Local).AddTicks(4937),
                            Name = "Vegapakket",
                            Opgehaald = false,
                            Price = 12.99,
                            TypeMeal = "Gezond"
                        ...
                        new
                        {
                            Id = 4,
                            CantineId = 2,
                            DeadlineDate = new DateTime(2022, 10, 11, 0, 2, 4, 398, DateTimeKind.Local).AddTicks(4940),
                        ...
                        new
                        {
                            Id = 5,
                            CantineId = 1,
                            DeadlineDate = new DateTime(2022, 10, 12, 0, 2, 4, 398, DateTimeKind.Local).AddTicks(4943),
                            Name = "Snackpakket",
                            Opgehaald = false,
                            Price = 12.5,
                            TypeMeal = "Snack"
